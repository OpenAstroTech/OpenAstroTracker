...
; Generated by Eor Equis on 4/12/2020 (UTC)
;
[Setup]
AppID={{32715460-939c-4eed-8e32-a153dfb55f7f}
AppName=ASCOM OpenAstroTracker Telescope Driver
AppVerName=ASCOM OpenAstroTracker Telescope Driver 0.1.1
AppVersion=0.1.1
...
DefaultDirName="{cf}\ASCOM\Telescope\OpenAstroTracker"
DisableDirPage=yes
...
[Files]
Source: "D:\Dev\Git\OpenAstroTracker\Software\OpenAstroTracker ASCOM\OpenAstroTracker ASCOM\bin\Release\OpenAstroTracker ASCOM.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Dev\Git\OpenAstroTracker\Software\OpenAstroTracker ASCOM\OpenAstroTracker ASCOM\ReadMe.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\OpenAstroTracker ASCOM.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\OpenAstroTracker ASCOM.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\OpenAstroTracker ASCOM.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\OpenAstroTracker ASCOM.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\OpenAstroTracker ASCOM.dll"""; Flags: runhidden 64bit; Check: IsWin64
