...
namespace MenuPrototype
{
	partial class Program
	{
		...
		static int driftLength = 0;

		private static void setDriftLength(EventArgs args)
		{
			driftLength = int.Parse((args.source as OptionChooser).getSelected().Substring(0,1));
			args.source.getMainMenu().activateDialog("DriftAlign")
		}
